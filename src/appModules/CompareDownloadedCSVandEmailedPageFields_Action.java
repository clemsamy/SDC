...
public class CompareDownloadedCSVandEmailedPageFields_Action extends BaseClass
{
	public static int NoOfRecords;	
	
	public CompareDownloadedCSVandEmailedPageFields_Action(WebDriver driver) 
	{
		super(driver);
	...
	public static void Execute(String Env) throws Exception
	{
		    ...
		    try{		    
				    Variables.OutputBuffer = Variables.OutputBuffer + "\n======================================================================";
			      	Variables.OutputBuffer = Variables.OutputBuffer + "\n"+Env+": Emailed CSV File Vs Downloaded CSV Fields Comparision Results";
			      	Variables.OutputBuffer = Variables.OutputBuffer + "\n======================================================================";	      	
					...
					if (Env.equalsIgnoreCase("ST"))
			  		{
			  			...
			  			if(Utils.CompareCSVFiles(Config.Path_MRCFieldOutput+"Exported-"+Config.File_CSVExportSTFields,Config.Path_MRCFieldOutput+"Converted-Emailed-"+Config.File_CSVExportSTFields ))
					...
					else if(Env.equalsIgnoreCase("UAT"))
			  		{
			  			...
			  			Utils.convertXLSXFileToCSV(myXLSXFile,NewCSVConvertedFile);*/
			  			if(Utils.CompareCSVFiles(Config.Path_MRCFieldOutput+"Exported-"+Config.File_CSVExportUATFields,Config.Path_MRCFieldOutput+"Converted-Emailed-"+Config.File_CSVExportUATFields ))
			  				BaseClass.bResult=true;
			  			else
			  				BaseClass.bResult=false;			  			
			  		}
					Utils.writeFileCompareOutput(Config.Path_MRCFieldOutput,"Emailed-Vs-Downloaded-"+Env+"-"+Config.File_CompareOutput,Variables.OutputBuffer);
