...
public class UATFileProcessing
{
 ...
 @Parameters({"Browser","Environment",})
  ...
  @Test (priority = 1)
  @Parameters({"Username","UATPassword","Environment"})
  public void UATMRCFileProcessing(String Username,String Password, String Env) throws Exception 
  {
	  try
	  {  	
			...
			if(BaseClass.bResult==true)
			{
				...
				System.out.println("Final: SDC-UAT All MRC file processing completed successfully");
				Reporter.log("Final: SDC-UAT All MRC file processing completed successfully");
				Log.info("Final: SDC-UAT All MRC file processing completed successfully");
			}
			else
			{
				System.out.println("Final: SDC-UAT MRC file processing interuppted");
				Reporter.log("Final: SDC-UAT MRC file processing interuppted");
				Log.info("Final: SDC-UAT MRC file processing interuppted");
  ...
  public void afterMethod() throws IOException 
  {
	    ...
	    Log.endTestCase(sTestCaseName);	    
	    	...
	    	//***Zip and send email after test finished
